...
func HostVisibleBytes() uint64 { return 0 }
func Alloc(uint64) Buf                 { return 0 }
func AllocE(n uint64) (Buf, error)     { return 0, errNoGPU }
func Free(Buf)              {}
func PoolCreate(uint64) error { return errNoGPU }
func PoolSeal()            {}
func PoolDestroy()          {}
...
func BatchAttentionF16(out, q, kc, vc Buf, nh, nkv, hd, kvd, sl int, s, sc float32, n int) error { return errNoGPU }
func Sync()                                 {}
func PerfReset()                            {}
func PerfPrint()                            {}
func PerfGetGpuUs() float64                 { return 0 }
func PerfGetDispatches() int                { return 0 }
func PerfGetBarriers() int                  { return 0 }
...
func MoEMatVecIQ(o, w, x, tb, i Buf, r, c int, t uint32, es, bo, si, nu int) error { return errNoGPU }
...
func GemmQ4K(out, weights, x Buf, M, K, N int) error         { return errNoGPU }
func SplitQKV(q, k, v, qkv Buf, qDim, kvDim, seqLen int) error { return errNoGPU }
...
func ForwardMoEFFN_Native_C(mc *MoEFFNConf) error                                      { return errNoGPU }
