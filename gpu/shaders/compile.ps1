...
static const ShaderInfo shader_registry[] = {
    ...
    {"matvec_q4_0", spv_matvec_q4_0, spv_matvec_q4_0_size, 3, 8},   // PIPE_MATVEC_Q4_K (placeholder)
    {"matvec_q4_0", spv_matvec_q4_0, spv_matvec_q4_0_size, 3, 8},   // PIPE_MATVEC_Q5_0 (placeholder)
    {"matvec_q4_0", spv_matvec_q4_0, spv_matvec_q4_0_size, 3, 8},   // PIPE_MATVEC_Q6_K (placeholder)
    ...
    {"rope",        spv_rope,        spv_rope_size,        2, 20},  // PIPE_ROPE
...
$header | Out-File -FilePath "..\shaders_spirv.h" -Encoding ascii
Write-Host "Generated shaders_spirv.h"
